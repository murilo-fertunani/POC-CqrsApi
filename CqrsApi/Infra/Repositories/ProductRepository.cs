...
using CqrsApi.Infra.Contexts;
using CqrsApi.Infra.Repositories.Interfaces;
using Microsoft.EntityFrameworkCore;

namespace CqrsApi.Infra.Repositories
{
    public class ProductRepository : IProductRepository
    {
        ...
        private IQueryable<ProductEntity> Filter(IQueryable<ProductEntity> query, GetAllProductsRequest filter)
        {
            if (filter is null)
                return query;
